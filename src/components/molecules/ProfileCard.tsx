      ...
      <div>
        ...
        <div className="flex flex-wrap gap-2">
          <a
            ...
            className="inline-flex items-center gap-2 rounded-full border border-stone-600 bg-stone-700/80 px-3 py-1.5 text-sm font-medium text-green-200 transition-colors hover:border-green-600/50 hover:bg-green-900/40 hover:text-green-100"
          >
            <svg
            ...
            <span>/{contact.githubId ?? "username"}</span>
          </a>
          <a
          ...
          >
            ...
            <span>/{contact.linkedinId ?? "username"}</span>
          </a>
        </div>
      </div>
    </div>
