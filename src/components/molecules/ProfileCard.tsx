      ...
      <div>
        ...
        <div className="flex flex-wrap gap-2">
          <a
            ...
            className="inline-flex items-center gap-2 rounded-full border border-gray-600 bg-gray-700/80 px-3 py-1.5 text-sm font-medium text-gray-300 transition-colors hover:border-gray-500 hover:bg-gray-600 hover:text-white"
          >
            <svg
          ...
          >
            ...
            <span>in/{contact.linkedinId ?? "username"}</span>
          </a>
        </div>
      </div>
    </div>
